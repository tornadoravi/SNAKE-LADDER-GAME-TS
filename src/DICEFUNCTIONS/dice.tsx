...
export default function Dice() {
  ...
  const [playerswinner, setPlayerwinner] = useState(String)
  ...
  function dicerollfunction() {
    ...
    console.log((refClickCount===0)===(diceRandom===1),"chechuuuuuuuuuuuuuuuuu")
        ...
        boxArr.forEach((ids) => {
          if (ids.id === `boxId${(player1Position + diceRandom)}`) {
            if (ids.to !== '') {
              ...
              setPlayer1Position(Number(ids.to))
        ...
        boxArr.forEach((ids) => {
          if (ids.id === `boxId${(player2Position + diceRandom)}`) {
            ...
            if (ids.to !== '') {
              ...
              setPlayer2Position(Number(ids.to))
    ...
    if ((player1Position) === 100) {
      setPlayerwinner(String("🏆player1winner🕺"))
      console.log('player 1 winner')
    }
    else if ((player2Position) === 100) {
      setPlayerwinner(String("🏆player2winner🕺"))
